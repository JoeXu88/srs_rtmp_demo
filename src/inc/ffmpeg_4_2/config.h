...
#define FFMPEG_CONFIGURATION "--enable-shared --disable-static --prefix=./vs2019_build_dll --extra-ldflags='/NODEFAULTLIB:libcmt' --extra-cflags=-MDd --enable-debug --toolchain=msvc"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "./vs2019_build_dll/share/ffmpeg"
#define AVCONV_DATADIR "./vs2019_build_dll/share/ffmpeg"
#define CC_IDENT "用于 x86 的 Microsoft (R) C/C++ 优化编译器 19.24.28314 版"
